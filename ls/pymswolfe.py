...
class StrongWolfeLineSearch:
    ...
    * f_g	Returns tuple of objective / objective gradient
    ...
    """
    def __init__(self, f, x, g, d, F_G, **kwargs):
        ...
        self.F_G  = F_G   # To evaluate function value
    ...
    def search(self):
        ...
        while info == -1:
            self.f, self.g = self.F_G(self.x)

            self.xs.append(self.x.copy())
            self.slopes.append(numpy.dot(self.g, self.d))
